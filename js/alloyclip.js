...
;(function () {
    ...
    // isFixed  固定选取框 缩放图片
    var singleAC = function (el, _w, _h, isFixed,BORder) {
        _w = _w || 80;
        _h = _h || 80;
        ...
        rightTitle.innerHTML = "<i class=\"fa fa-eye\" aria-hidden=\"true\"></i> 预览";
        rightInfo.innerHTML = _w + "×" + _h +" (px)";
        confirmButton.innerHTML = "<i class=\"fa fa-check-square-o\" aria-hidden=\"true\"></i> 确定";
        switchPic.innerHTML = "<i class=\"fa fa-exchange\" aria-hidden=\"true\"></i> 切换图片";
        ...
        getOption: function () {
            ...
            return this.optionEl || function () {
                ...
                navItemWrapper.innerHTML =
                    "<li id='alteration'><i class=\"fa fa-adjust\"></i> 调节</li>" +
                    "<li id='filter'><i class=\"fa fa-filter\"></i> 滤镜</li>" +
                    "<li id='border'><i class=\"fa fa-object-group\"></i> 边框</li>";
                ...
                rotate.innerHTML = "旋转 <i class=\"fa fa-repeat\" aria-hidden=\"true\"></i>";
                ...
                var alterationHandler = function (e) {
                    ...
                    var SBar = _this.getScrollBar(160, 0.5, "色相", "apH", callback);
                    var HBar = _this.getScrollBar(160, 0.5, "饱和度", "apS", callback);
                    var IBar = _this.getScrollBar(160, 0.5, "亮度", "apI", callback);
    ...
    var AC = function (selector, width, height, isFixed,BORder) {
        if (typeof selector == "object") {
            ...
            for (var i = 0; i < el.length; i++) {
                acPool.push(new singleAC(el[i], width, height, isFixed,BORder));
            }
