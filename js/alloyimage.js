...
(function (e) {
    ...
    var t = function () {
        ...
        lib: [], definedPs: {}, init: function () {
            ...
            var t = this, n = document.createElement("script");
            ...
            var r = this.lib.config.getModuleName(e), i = r.spaceName, s = r.actName;
            switch (i) {
                case"Filter":
                case"Alteration":
    ...
    window[e] = function (r, i, s) {
        ...
        var u = document.createElement("canvas"), a = u.getContext("2d");
        if (!isNaN(r)) u.width = r, u.height = i, s = s || "#fff", a.fillStyle = s, a.fillRect(0, 0, r, i), this.srcImg = ""; else if (typeof r == "string") {
            var f = new Image;
            f.onload = function () {
                u.width = parseInt(this.width), u.height = parseInt(this.height), a.drawImage(this, 0, 0, this.width, this.height)
            }, f.src = r
        } else {
            var l = i, c = s, h = r.width, p = r.height, d = h / p;
        ...
        set width(e) {
            ...
            return !t && this.useWorker ? (this.dorsyWorker.queue.push(["replace", e]), r.call(this), this) : (e && (e.onload = function () {
            }, e.src = this.save(0, 1, t)), this)
        }, add: function () {
            var e = [], t, i, s, o, u, a, f;
            ...
            var i = this.save(r, t), s = document.createElement("a");
            ...
            var i = window[e].dorsyMath(), s = this.ctxContext;
            ...
            var r = this, i = this.width, s = this.height, o, u;
            n || (n = t * s / i), t || (t = n * (i / s));
            if (t && n) return o = t / i, u = n / s, this.scale(o, u)
        }, rotate: function (e) {
            var t = e / 180 * Math.PI, n = [Math.cos(t), Math.sin(t), -Math.sin(t), Math.cos(t), 0, 0];
    ...
    window[e].module("addLayer", function (e) {
        var t = {
            add: function (e, t, n, r, i, s, o, u) {
                var a = e.data, f = t.data, i = i || 0, s = s || 0, r = r || 1, o = o || !1, u = u || "RGB";
                /[RGB]+/.test(u) || (u = "RGB");
                var l = u.replace("R", "0").replace("G", "1").replace("B", "2"), c = 1, h, p = e.width, d = e.height,
                    v = f.length, m = t.width, g = t.height,
                    y = [l.indexOf("0") > -1, l.indexOf("1") > -1, l.indexOf("2") > -1], b = 4 * c, w, E, S, x, T, N, C,
                    k, L, A, O, M = i, _ = i + m, D = s, P = s + g;
                if (M > p) return;
                M < 0 && (M = 0);
                if (_ < 0) return;
                _ > p && (_ = p);
        ...
        var t = {
            process: function (t, n) {
                ...
                for (var f = 0, l = i.length; f < l; f += 4) {
                    ...
                    var S = new e.lib.dorsyMath.Matrix(d, 3, matrixSize), x = S.mutiply(u);
    ...
    window[e].module("dorsyMath", function (e) {
            ...
            FFT1: function (e) {
                ...
                function u(r, s, o) {
                    ...
                    for (var a = r, f = 0; a <= s - u; a++) {
                        var l = a + u, c = f * n / Math.pow(2, o), h = c + n / 4;
                        e[a] instanceof t.C || (e[a] = new t.C(e[a])), e[l] instanceof t.C || (e[l] = new t.C(e[l]));
                        var p = e[a].plus(e[l].mutiply(i[c])), d = e[a].plus(e[l].mutiply(i[h]));
                        e[a] = p, e[l] = d, f++
                    }
                }
                ...
                var r = [];
                if (t) {
                    if (isNaN(t)) var i = /(\d+)\s*\*/.exec(t)[1], s = /\*\s*(\d+)/.exec(t)[1]; else i = t, s = n;
                ...
                i = i || 0;
                var s = n.data, o = n.width, u = n.height, a = r.length, f = new t.Matrix(r, a, 1), l = [],
                    c = -(Math.sqrt(a) - 1) / 2;
                for (var h = 0, p = s.length; h < p; h += 4) {
                    var d = h / 4, v = parseInt(d / o), m = d % o;
                    if (v == 0 || m == 0) continue;
                    var g = [[], [], []];
                    for (var y = c; y <= -c; y++) {
                        var b = v + y;
                    ...
                    var N = new e.lib.dorsyMath.Matrix(g, 3, a), C = N.mutiply(f);
                ...
                if (e + t + n > 0) var s = 1 - 3 * Math.min(e, t, n) / (e + t + n); else var s = 0;
                var o = (e + t + n) / 3;
                return i > 2 * Math.PI && (i = 2 * Math.PI), i < 0 && (i = 0), {H: i, S: s, I: o}
                ...
                if (e <= Math.PI * 2 / 3) var r = n * (1 - t),
                    ...
                    s = 3 * n - (i + r); else if (e <= Math.PI * 4 / 3) {
                    e -= Math.PI * 2 / 3;
                    var i = n * (1 - t), s = n * (1 + t * Math.cos(e) / Math.cos(Math.PI / 3 - e)), r = 3 * n - (s + i)
                } else {
                    e -= Math.PI * 4 / 3;
                    var s = n * (1 - t), r = n * (1 + t * Math.cos(e) / Math.cos(Math.PI / 3 - e)), i = 3 * n - (s + r)
                }
                return {R: i, G: s, B: r}
            }, applyInHSI: function (e, t) {
                var n = ["R", "Y", "G", "C", "B", "M"], r = e.data, i = Math.PI / 6, s = Math.PI / 3;
                for (var o = 0, u = r.length; o < u; o += 4) {
                    var a = this.RGBToHSI(r[o], r[o + 1], r[o + 2]), f = a.H + i, l = ~~(f / s), c = n[l % 6];
                ...
                var s = this.xyToIFun(e.width), o = s(t, n, 0), u = e.data, a = r(u[o], u[o + 1], u[o + 2]);
        ...
        return t.Matrix.prototype = {
            ...
            plus: function (e) {
                ...
                var n = new t.C, r = e.mutiply(e.conjugated()), i = this.mutiply(e.conjugated());
        ...
        var t = 200, n = function (n) {
            ...
            var i = {
                queue: [], startWorker: function () {
                    ...
                    var s = e[0];
                    if (s == "act") r.postMessage(["act", e[1], n.imgData, e[2]]); else if (s == "add") {
                        function o() {
                            if (e[1].readyState) {
    ...
    window[e].module("Fix", function (e) {
        function t(e) {
            var t = e.naturalWidth, n = e.naturalHeight, r = document.createElement("canvas");
            r.width = 1, r.height = n;
            var i = r.getContext("2d");
            i.drawImage(e, 0, 0);
            var s = i.getImageData(0, 0, 1, n).data, o = 0, u = n, a = n;
            while (a > o) {
                var f = s[(a - 1) * 4 + 3];
                f === 0 ? u = a : o = a, a = u + o >> 1
            }
    ...
    window[e].module("Tools", function (e) {
        var t = {
            getColor: {
                process: function (t, n) {
                    var r = e.lib.dorsyMath, i = r.xyToIFun(t.width), s, o = [0, 0, 0], u = 50, a = Math.PI * 2 / u, f,
                        l = [];
                    ...
                    var y = p * a, b = r.HSIToRGB(y, v, g),
                        w = "rgb(" + parseInt(b.R) + "," + parseInt(b.G) + "," + parseInt(b.B) + ")";
                    return w
                }
            }, toText: {
                process: function (t, n) {
                    var r = t.data, i = t.width, s = t.height, o, u = n[0] || ".:;!#@", a = [], f = "";
                    console.log(u);
                    var l = e.lib.dorsyMath, c = l.xyToIFun(t.width), h, p = 255 / u.length, d;
                    for (var v = 0; v < i; v += 1) {
    ...
    window[e].module("Alteration.brightness", function (e) {
        var t = {
            process: function (e, t) {
                var n = e.data, r = t[0] / 50, i = t[1] || 0, s = i / 50, o = Math.tan((45 + 44 * s) * Math.PI / 180);
    ...
    window[e].module("Alteration.curve", function (e) {
        var t = {
            process: function (t, n) {
                var r = e.lib.dorsyMath.lagrange(n[0], n[1]), i = t.data, s = t.width, o = t.height, u = n[2];
                /[RGB]+/.test(u) || (u = "RGB");
    ...
    window[e].module("Alteration.gamma", function (e) {
        var t = {
            process: function (t, n) {
                var r = e.lib.dorsyMath, i = t.data, s = t.width, o = t.height, u;
    ...
    window[e].module("Alteration.selectiveColor", function (e) {
        var t = {
            process: function (t, n) {
                var r = n[0], i = n[1], s = n[2], o = n[3], u = n[4], a = n[5] || 0, f = {
                    red: "R",
                    green: "G",
                    blue: "B",
                    "\u7ea2\u8272": "R",
                ...
                }, h = 0, p = 0, d = 0, v = [i, s, o, u];
                for (var m = 0, g = t.width; m < g; m++) for (var y = 0, b = t.height; y < b; y++) e.lib.dorsyMath.xyCal(t, m, y, function (e, t, n) {
                    var i = {R: e, G: t, B: n}, s = [e, t, n], o = [];
                    if (c(i)) {
                        if (f[r]) {
                            var h = f[r], p = e + t + n - Math.max(e, t, n) - Math.min(e, t, n);
                            d = i[h] - p
                        } else if (l[r]) {
                            var m = l[r], p = e + t + n - Math.max(e, t, n) - Math.min(e, t, n);
                            d = p - i[m]
                        } else if (r == "black" || r == "\u9ed1\u8272") d = parseInt(127.5 - Math.max(e, t, n)) * 2; else if (r == "white" || r == "\u767d\u8272") d = parseInt(Math.min(e, t, n) - 127.5) * 2; else {
                            if (r != "\u4e2d\u6027\u8272") return;
                            d = 255 - (Math.abs(Math.max(e, t, n) - 127.5) + Math.abs(Math.min(e, t, n) - 127.5))
                        }
                        for (var g = 0; g < 3; g++) {
                            var y = parseInt(d * (s[g] / 255)), b = s[g] - y, w = parseInt(d * (1 - s[g] / 255)),
                                E = s[g] + w, S = v[g] + u + v[g] * u;
                            if (a) {
                                s[g] > 128 && (y = w);
                                if (u > 0) var x = s[g] - u * y; else var x = s[g] - u * w;
    ...
    window[e].module("Filter.corrode", function (e) {
        var t = {
            process: function (e, t) {
                var n = parseInt(t[0]) || 3, r = e.data, i = e.width, s = e.height, o = n * 2 + 1;
                for (var u = 0; u < i; u++) for (var a = 0; a < s; a++) {
                    var f = parseInt(Math.random() * n * 2) - n, l = parseInt(Math.random() * n * 2) - n, c = a * i + u,
                        h = (a + f) * i + u + l;
    ...
    window[e].module("Filter.dotted", function (e) {
        var t = {
            process: function (t, n) {
                var r = parseInt(n[0]) || 1, i = parseInt(n[1]) || 1, s = t.data, o = t.width, u = t.height,
                    a = r * 2 + 1, f = [], l = i * i;
                ...
                for (var c = 0, d = parseInt(o / a); c < d; c++) for (var h = 0, v = parseInt(u / a); h < v; h++) {
                    var m = parseInt((c + .5) * a), g = parseInt((h + .5) * a);
                    for (var y = 0; y < f.length; y++) {
                        var b = m + f[y][0], w = g + f[y][1];
    ...
    window[e].module("Filter.embossment", function (e) {
        var t = {
            process: function (e, t) {
                var n = e.data, r = e.width, i = e.height, s = [];
                for (var o = 0, u = n.length; o < u; o += 4) {
                    var a = o / 4, f = parseInt(a / r), l = a % r, c = ((f - 1) * r + (l - 1)) * 4,
                        h = (f + 1) * r * 4 + (l + 1) * 4;
                    if (f == 0 || l == 0) continue;
    ...
    window[e].module("Filter.gaussBlur", function (e) {
        var t = {
            process: function (e, t, n) {
                var r = e.data, i = e.width, s = e.height, o = [], u = 0, a, f, l, c, h, p, d, v, m, g;
    ...
    window[e].module("Filter.posterize", function (e) {
        var t = {
            process: function (t, n) {
                var r = e.lib.dorsyMath, i = t.data, s = t.width, o = t.height, u = n[0] || 20;
                u = u < 1 ? 1 : u > 255 ? 255 : u;
    ...
    window[e].module("Filter.sepia", function (e) {
        var t = {
            process: function (t) {
                var n = e.lib.dorsyMath, r = t.data, i = t.width, s = t.height;
